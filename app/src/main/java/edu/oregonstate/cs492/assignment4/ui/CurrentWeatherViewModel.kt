 ...
 */
class CurrentWeatherViewModel(private val cityDao: CityDao): ViewModel() {
    ...
    fun loadCurrentWeather(location: String?, units: String?, apiKey: String) {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                // Assuming the location is a non-null String, update or insert the city in the database
                location?.let {
                    val city = City(name = it, lastViewed = System.currentTimeMillis())
